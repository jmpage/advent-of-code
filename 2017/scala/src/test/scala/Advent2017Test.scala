...
class Day1Test extends FlatSpec with Matchers {
  ...
  "solve(1122)" should "be 3" in {
    Day1.solve("1122") should be (3)
  }

  "solve(1111)" should "be 4" in {
    Day1.solve("1111") should be (4)
  }

  "solve(1234)" should "be 0" in {
    Day1.solve("1234") should be (0)
  }

  "solve(91212129)" should "be 9" in {
    Day1.solve("91212129") should be (9)
  }

  "solve2(1212)" should "be 6" in {
    Day1.solve2("1212") should be (6)
  }

  "solve2(1221)" should "be 0" in {
    Day1.solve2("1221") should be (0)
  }

  "solve2(123425)" should "be 4" in {
    Day1.solve2("123425") should be (4)
  }

  "solve2(123123)" should "be 12" in {
    Day1.solve2("123123") should be (12)
  }

  "solve2(12131415)" should "be 4" in {
    Day1.solve2("12131415") should be (4)
  }
}
...
class Day2Test extends FlatSpec with Matchers {
  ...
  "checksum" should "be 18" in {
    Day2.checksum("""5 1 9 5
                    |7 5 3
                    |2 4 6 8""".stripMargin) should be (18)
  }

  "checksum" should "solve" in {
    Day2.checksum("""1208	412	743	57	1097	53	71	1029	719	133	258	69	1104	373	367	365
                    ...
                    |525	1263	146	954	188	232	1019	918	268	172	1196	1091	1128	234	650	420""".stripMargin
    ) should be (1)
  }
}
